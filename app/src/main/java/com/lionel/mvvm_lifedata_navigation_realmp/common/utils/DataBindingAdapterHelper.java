...
public class DataBindingAdapterHelper {
    ...
    public static void setImageCircleWithGlide(ImageView view, Drawable drawable) {
        Glide.with(view).load(drawable).apply(RequestOptions.bitmapTransform(new CircleCrop())).into(view);
